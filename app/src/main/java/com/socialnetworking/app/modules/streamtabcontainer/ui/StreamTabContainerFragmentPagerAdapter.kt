...
import com.socialnetworking.app.modules.stream.ui.StreamFragment
import kotlin.Int
import kotlin.String
import kotlin.collections.List

class StreamTabContainerFragmentPagerAdapter(
    ...
    companion object AdapterConstant {
        ...
        val viewPages: List<Fragment> =
                listOf(StreamFragment(),StreamFragment(),StreamFragment(),StreamFragment())
